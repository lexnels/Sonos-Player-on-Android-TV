...
3. On the sending device, pick the Sonos Player on TV APK and send it to the TV.
...
3. When it is installed, find **Sonos Player on TV** in your apps row and open it.
